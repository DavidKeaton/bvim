...
BINDIST_CMD    = tar --transform=s@^$(BINDIST_DIR)@bvim-$(VERSION)@ -czvf $(BINDIST) $(BINDIST_DIR)
...
cataclysm.a: $(ODIR) $(DDIR) $(OBJS)
	ar rcs bvim.a $(filter-out $(ODIR)/main.o,$(OBJS))
